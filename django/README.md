...
Без лайков (2009), без Messenger/WebSocket/групповых чатов, без PYMK, без центра уведомлений, без опросов/репостов/стикеров/PWA, без status-publisher на ленте (статус — в шапке профиля).
