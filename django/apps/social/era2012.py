...
APP_CENTER = (
    ...
    {"slug": "videos", "name": "Видео", "category": "media", "featured": True,
     "blurb": "Загрузите ролик или ссылку.", "detail": "Видеофайл (MP4/WebM) или URL — хранение на том же медиа-диске, что и фото; HTML5-плеер в classic chrome.", "url_name": "videos"},
    ...
    {"slug": "og", "name": "Активность", "category": "media", "featured": True,
     "blurb": "Слушаете, читаете, смотрите.", "detail": "Публикуйте истории активности: музыка, книги, фильмы — в ленте и Ticker.", "url_name": "og"},
