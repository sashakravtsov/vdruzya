...
PLATFORM_APPS = (
    ...
    # Sample first-party App Center demos (developer chrome: ВДрузья)
    {
        ...
        "category": "utilities",
        "featured": True,
        "blurb": "50 точных калькуляторов: отпускные, кредит, НДС 22%, ИМТ и др.",
        "detail": (
            "Первое лицо ВДрузья: набор профессиональных калькуляторов "
            "по спросу Wordstat — HR, финансы, налоги (НДС 22% с 2026), стройка, здоровье. "
            "Формулы прозрачны, без iframe сторонних сайтов."
        ),
        "developer": "ВДрузья",
    ...
    },
    {
        ...
        "category": "games",
        "featured": False,
        "blurb": "Шахматная доска для партии с другом.",
        "detail": "Доска и ход фигурой — учебная партия без движка.",
        "developer": "ВДрузья",
        "permissions": DEFAULT_PERMISSIONS,
    },
    {
