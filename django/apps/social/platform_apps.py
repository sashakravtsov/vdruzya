...
PLATFORM_APPS = (
    ...
    },
    {
        ...
        "category": "lifestyle",
        "featured": True,
        "blurb": "Лента, лайки, матчи и школа общения в кругу ВДрузья.",
        "detail": (
            "Знакомства ВДрузья: discovery среди друзей и людей рядом, "
            "лайки и суперлайки, взаимные матчи с айсбрейкерами, "
            "цели дня и школа этикета — first-party canvas без стороннего iframe."
        ),
        "developer": "ВДрузья",
        "permissions": (
            "Основная информация профиля",
