...
urlpatterns = [
    ...
    path("messenger/archive", msg.messenger_bulk, name="messenger.archive"),
    path("messenger/bulk", msg.messenger_bulk, name="messenger.bulk"),
    ...
    path("messenger/<int:conversation_id>/older", msg.messages_older, name="messages.older"),
    path("messenger/<int:conversation_id>/leave", msg.messenger_leave, name="messenger.leave"),
    path("messenger/<int:conversation_id>/restore", msg.messenger_restore, name="messenger.restore"),
    path("messenger/<int:conversation_id>/purge", msg.messenger_purge, name="messenger.purge"),
    path("messenger/<int:conversation_id>/spam", msg.messenger_spam, name="messenger.spam"),
    path("messenger/<int:conversation_id>/unread", msg.messenger_unread, name="messenger.unread"),
    path("messenger/<int:conversation_id>/title", msg.messenger_title, name="messenger.title"),
    path("messenger/<int:conversation_id>/invite", msg.messenger_invite, name="messenger.invite"),
