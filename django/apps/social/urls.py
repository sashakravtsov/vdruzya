...
urlpatterns = [
    ...
    path("inbox/<int:conversation_id>/unread", inbox.inbox_unread, name="inbox.unread"),
    path("inbox/<int:conversation_id>/spam", inbox.inbox_spam, name="inbox.spam"),
    path("inbox/<int:conversation_id>/purge", inbox.inbox_purge, name="inbox.purge"),
    path("inbox/<int:conversation_id>/since", rt.inbox_since, name="inbox.since"),
    path("inbox/<int:conversation_id>/older", rt.inbox_older, name="inbox.older"),
    ...
    path("messages/<int:message_id>/forward", inbox.message_forward, name="messages.forward"),
    path("messages/<int:message_id>/delete", inbox.message_delete, name="messages.delete"),
    path("links/<int:pk>/edit", classic.posted_edit, name="links.edit"),
    path("videos/<int:pk>/edit", classic.posted_edit, name="videos.edit"),
